...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('personal-info-fields/reorder', [PersonalInfoFieldController::class, 'switchFormOrder']);
    ...
    Route::post('medical-history-fields/reorder', [MedicalHistoryFieldController::class, 'switchFormOrder']);
