...
class StoreMedicalHistoryFieldRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'form_order' => ['required', 'integer', 'unique:medical_history_field_versions,form_order', function ($attribute, $value, $fail) {
            ...
            'description_text' => 'sometimes|nullable|text',
        ];
    }
}
